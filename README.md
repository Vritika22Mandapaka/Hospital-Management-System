...
import java.awt.Color;
 ...
 class MyFrame
	...
	public MyFrame()
	{
		...
		title = new JLabel("Fivezers Hospitals");
		...
		tidno.setSize(150, 20);
		tidno.setLocation(200, 150);
		tidno.setForeground(Color.black);
		c.add(tidno);
        ...
        login_as= new JLabel("Login_as");
		login_as.setFont(new Font("Arial", Font.PLAIN, 20));
		login_as.setSize(100, 20);
		login_as.setLocation(100, 300);
		login_as.setForeground(Color.yellow);
		c.add(login_as);

		patient = new JRadioButton("Patient");
		patient.setFont(new Font("Arial", Font.PLAIN, 15));
		patient.setSelected(true);
		patient.setSize(75, 20);
		patient.setLocation(200, 300);
		c.add(patient);
			...
			if (term.isSelected()) {
				...
				String data2
					...
					if (patient.isSelected())
					  data3 = "Login_as : Patient"
							+ "\n";
				else
					  data3 = "Login_as : Doctor"
							+ "\n";
